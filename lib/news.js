...
export const TOWN_KEYS = [
  ...
  'le chatenet en dognon',   'le chatenet-en-dognon',   'le dorat',   'le palais sur vienne',   'le palais-sur-vienne',   'le vigen',   'le-buis',   'le-chalard',
...
export function isStrictMatch(matches, context = {}){
  ...
  // Correction: do not show news with only 'candidat' or 'candidats' as match
  if (
    norm.length === 1 &&
    (norm[0] === 'candidat' || norm[0] === 'candidats')
  ) return false;
  return hasRegion;
}
